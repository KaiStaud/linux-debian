cmd_vmlinux := scripts/link-vmlinux.sh "arm-linux-gnueabihf-ld" "-EL -z noexecstack" "--no-undefined -X --pic-veneer -z norelro --build-id=sha1 --orphan-handling=warn";  true
